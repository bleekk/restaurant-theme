...
<style>
    ...
    #articleslider .owl-controls .owl-page {
    display: inline-block;
    }
    #articleslider .owl-pagination{
        text-align: center;
    }
    #articleslider .owl-controls .owl-page span {
...
<div class="pub_article_t_top">
    ...
    <{if $item.image_path || $item.images}>
        <figure>
        <{if $item.images}>
            <div id="articleslider" class="owl-theme" style="margin-bottom:10px">
                <div class="item" >
